    ...
    return (
        <header className="app-header">
            ...
            <Link to={"/"} className="logo-link" aria-label="home">
                <svg className="header-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" aria-hidden="true">
            ...
            {/* Placeholder / actions right */}
            <div className="right-slot" aria-hidden="true"></div>
        </header>
    )
}